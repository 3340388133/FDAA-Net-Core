"""
Multi-Granularity Forgery Perception Module (MGFP)
创新点2：多粒度伪造感知模块

V1: 原始版本 (PatchForgeryAttention + MultiGranularityAggregation)
V2: 改进版本 (AttentionPooling + LateFusionAggregation，接收频率特征)

参考论文:
- LAA-Net (CVPR 2024): Localized Artifact Attention Network
- Multi-attentional Deepfake Detection (CVPR 2021)
- Hong et al., "Contrastive Learning for DeepFake Classification and Localization", CVPR 2024
"""
