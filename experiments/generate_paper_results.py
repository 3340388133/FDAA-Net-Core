...
Usage:
    python experiments/generate_paper_results.py --input outputs/full_experiments/results_all_*.json
    python experiments/generate_paper_results.py --input outputs/comprehensive/*.json --format latex
"""
