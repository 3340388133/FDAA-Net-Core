...
![Fig.1 FDAA-Net整体架构图](fig01_architecture_overview.png)
...
![Fig.2 频域特征覆盖范围对比](fig02_method_comparison.png)
...
![Fig.12 FDAA特征提取与注意力可视化](fig12_attention_maps.png)
...
![Fig.13 融合方式对比](fig13_fusion_comparison.png)
...
![Fig.10 训练动态](fig10_training_curves.png)
...
![Fig.11 t-SNE特征可视化](fig11_tsne_visualization.png)
...
![Fig.3 鲁棒性衰减折线图](fig03_robustness_degradation.png)
...
![Fig.4 SOTA鲁棒性热力图](fig04_robustness_heatmap.png)
...
![Fig.6 跨数据集泛化雷达图](fig06_cross_dataset_radar.png)
...
![Fig.7 Leave-One-Out柱状图](fig07_leave_one_out.png)
...
![Fig.5 消融综合分析](fig05_ablation_combined.png)
...
![Fig.14 消融鲁棒性热力图](fig14_ablation_robustness_heatmap.png)
...
![Fig.9 损失消融分析](fig09_loss_ablation.png)
...
![Fig.8 性能-鲁棒性-效率散点图](fig08_efficiency_scatter.png)
